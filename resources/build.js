...
let wtHTML = hhHTML.replace("<option>Weight", "<option selected>Weight").replace("- Height", "- Weight");
let bmiHTML = hhHTML.replace("<option>BMI", "<option selected>BMI").replace("- Height", "- BMI");
...
Bun.write("../weight/index.htm", wtHTML);
